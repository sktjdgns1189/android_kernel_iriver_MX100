...
struct mtd_partition s3c_partition_info[] = {
	{
		...
		.size		= (256*SZ_1K),
//		.mask_flags	= MTD_CAP_NANDFLASH,	/* zsani2: MTD_CAP_NANDFLASH is not writable!!!!. refer to mtd-abi.h */
	},
	{
		.name		= "recovery",
	...
	{
		.name		= "env",
		.offset		= (512*SZ_1K),         /*Shanghai ewada for bootloader */
		.size		= (256*SZ_1K),
	},
	{
		.name		= "uboot",
		.offset		= (0*SZ_1K),           /*Shanghai ewada : DANGER!!! */
		.size		= (512*SZ_1K),
	}
};
