...
dm9000_probe(struct platform_device *pdev)
{
	...
	u32 id_val;
        ...
        /* // ? ??
        added by jhlim
        ethernet enable bit high.
        */

        #define GPJ2_BIT0_Hi              (*(unsigned long *)S5PV210_GPJ2DAT)   |= (0x1)
        #define GPJ2_BIT0_OUTP    (*(unsigned long *)S5PV210_GPJ2CON)  |=  1
         (*(unsigned long *)S5PV210_GPJ2PUD)  &= ~(0x1);        // Pull Up/
//Down Disable // 10
        GPJ2_BIT0_OUTP;
        GPJ2_BIT0_Hi;
