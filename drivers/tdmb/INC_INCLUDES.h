...
#endif
#define INTERRUPT_METHOD		// [S5PV210_Kernel], 20101124, ASJ, 
...
#define T3900_SCAN_IF_DELAY				1500 //400// [MX100_iRiver_ws], 20110113, ASJ, 
#define T3900_SCAN_RF_DELAY				1500
#define T3900_PLAY_IF_DELAY				1000 //400// [MX100_iRiver_ws], 20110113, ASJ, 정화승 책임
#define T3900_PLAY_RF_DELAY				1100 //1500// [MX100_iRiver_ws], 20110113, ASJ, 
...
#define INC_INTERRUPT_SIZE				(188 * 16)// [MX100_iRiver_ws], 20110125, ASJ, 
#define MAX_SUBCH_SIZE					32
#define MAX_SUBCHANNEL					32
#define MAX_LABEL_CHAR					16// [S5PV210_Kernel], 20101207, ASJ, 
...
#define INC_ENSEMBLE_LABLE_MAX				16 //  17// [S5PV210_Kernel], 20101207, ASJ, 
...
#endif
#ifdef INC_KERNEL_SPACE
#define INC_MALLOC(A) kmalloc(A, GFP_KERNEL)
#define INC_FREE(A)	kfree(A)
#else
#define IMC_MALLOC(A) malloc(A)
#define INC_FREE(A)	free(A)
#endif
