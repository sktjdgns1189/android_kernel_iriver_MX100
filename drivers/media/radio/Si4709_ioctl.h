...
/*max seq no*/
#define Si4709_IOC_NR_MAX 200    /* ktj */
...
/* ktj */
#define Si4709_IOC_FM_START                 _IOW(Si4709_IOC_MAGIC,  100, fmdata_t)
#define Si4709_IOC_FM_TUNE                  _IOW(Si4709_IOC_MAGIC,  101, fmdata_t)
#define Si4709_IOC_FM_VOLUME                _IOW(Si4709_IOC_MAGIC,  102, fmdata_t)
#define Si4709_IOC_FM_SEEK                  _IOWR(Si4709_IOC_MAGIC, 103, fmdata_t)
#define Si4709_IOC_FM_OUTPUT                _IOW(Si4709_IOC_MAGIC,  104, fmdata_t)
#define Si4709_IOC_FM_HPCONNECT             _IOR(Si4709_IOC_MAGIC,  105, fmdata_t)
#define Si4709_IOC_FM_STATUS                _IOR(Si4709_IOC_MAGIC,  106, fmdata_t)
#define Si4709_IOC_FM_STOP                  _IO(Si4709_IOC_MAGIC,   107)
#define Si4709_IOC_FM_VOLUME_TUNING   _IOW(Si4709_IOC_MAGIC,  108, fmdata_t)  /* JH LIM  */
