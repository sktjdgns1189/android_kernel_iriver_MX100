...
typedef struct
{
  ...
  u8 curr_rssi_th;
  u8 curr_snr;
  u8 curr_skcnt;  /* JHLIM 2011.04.26 */
}rssi_snr_t;
...
/* ktj */
extern fmdata_t fmdata;
extern int fm_init(void);
extern int fm_start(fmdata_t *fmdata);
extern int fm_tune(fmdata_t *fmdata);
extern int fm_scan(fmdata_t *fmdata);
extern int fm_output(fmdata_t *fmdata);
extern int fm_hpconnect(fmdata_t *fmdata);
extern int fm_status(fmdata_t *fmdata);
extern int fm_stop(void);
extern int fm_test(void);
extern int fm_volume(int volume);
extern int pllread(void);

extern int g_headset_connected; 
extern void wm8993_setpath_speaker(int onoff);
void set_fm_seekth(int _seekth);  /* JHLIM */
