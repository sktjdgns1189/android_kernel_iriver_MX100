...
#define  SDHCI_INT_DATA_MASK	(SDHCI_INT_DATA_END | SDHCI_INT_DMA_END | \
		...
		SDHCI_INT_DATA_END_BIT | SDHCI_ADMA_ERROR | SDHCI_INT_ADMA_ERROR)
...
/* Controller uses auto-command12 */
#define SDHCI_QUIRK_AUTOCMD12				(1<<30)
	int			irq;		/* Device IRQ */
...
#define SDHCI_DEVICE_DEAD	(1<<3)		/* Device unresponsive */
	...
	struct timer_list	fix_cpufreq_timer; /*Timer for fixing CPU freq */
	int			fixing_cpuclock;	/* Inform clock state */
#endif
