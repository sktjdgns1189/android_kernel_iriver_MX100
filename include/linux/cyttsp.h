...
/*
*/
//#define CYTTSP_USE_MT_SIGNALS jhlim
...
#define cyttsp_info(f, a...)		printk("%s:" f,  __func__ , ## a)
#define cyttsp_error(f, a...)		printk("%s:" f,  __func__ , ## a)
#define cyttsp_alert(f, a...)		printk("%s:" f,  __func__ , ## a)

#ifdef CYTTSP_USE_DEBUG
	#define cyttsp_debug(f, a...)	printk("%s:" f,  __func__ , ## a)
#else
	...
	#define cyttsp_xdebug(f, a...)	printk("%s:" f,  __func__ , ## a)
#else
	...
	#define cyttsp_xdebug1(f, a...)	printk("%s:" f,  __func__ , ## a)
#else
