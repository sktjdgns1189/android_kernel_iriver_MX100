...
#define V4L2_CID_CAPTURE			(V4L2_CID_PRIVATE_BASE + 54)

//Shanghai ewada:flashlight ioctl
#define V4L2_CID_FLASH_AUTO			(V4L2_CID_PRIVATE_BASE + 55)

//Shanghai ewada:based on samsung's patch
...
#define V4L2_CID_CAMERA_GET_AUTOFOCUS_STATUS		(V4L2_CID_PRIVATE_BASE + 119)

#define V4L2_CID_CAMERA_SET_CAMERA_SOURCE	    (V4L2_CID_PRIVATE_BASE + 120)
#define V4L2_CID_CAMERA_SET_CAMERA_FRAME_RATE	    (V4L2_CID_PRIVATE_BASE + 121)
