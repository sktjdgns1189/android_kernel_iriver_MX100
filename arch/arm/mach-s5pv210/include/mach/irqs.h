...
// [S5PV210_Kernel], 20101203, ASJ,   -Begin-
#define S5P_EINT_SET2(x)	S5PV210_GPH2(x)		// [S5PV210_Kernel], 20101122, ASJ, 
#define S5P_EINT_SET3(x)	S5PV210_GPH3(x)		// [S5PV210_Kernel], 20101122, ASJ, 

#define IRQ_GPIO_BASE		IRQ_EINT(31) + 1
#define NR_GPIO_IRQS		(24)

/* GPIO interrupt */			// [S5PV210_Kernel], 20101122, ASJ, 
#define S5P_GPIOINT_GROUP_NR	22
#define S5P_GPIOINT_BASE	(IRQ_EINT(31) + 1)
#define S5P_IRQ_GPIOINT(x)	(S5P_GPIOINT_BASE + (x))
// [S5PV210_Kernel], 20101203, ASJ,   -End-
