...
#define S3C_VENDOR_ID		0x1006
#define S3C_PRODUCT_ID		0x4031
#define S3C_ADB_PRODUCT_ID	0x4032
#ifdef CONFIG_USB_ANDROID_RNDIS
#define S3C_RNDIS_PRODUCT_ID 0x4033
#define S3C_RNDIS_ADB_PRODUCT_ID 0x4034
#endif
#else
...
static struct android_usb_platform_data android_usb_pdata = {
	...
	.product_id		= S3C_PRODUCT_ID,
#if defined(CONFIG_MX100) /* ktj */
	.manufacturer_name	= "iriver",
	.product_name		= "ILT-MX100",
#else
